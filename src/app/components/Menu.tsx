...
const categories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Ice Strawberry Matcha", description: "Matcha glacé, coulis fraise.", price: "16 DT", image: bubbleTeaImg, tag: "Matcha" },
      { name: "Ice Passion Matcha", description: "Matcha glacé, sirop passion.", price: "16 DT", image: tigerSugar, tag: "Matcha" },
      { name: "Matcha Latte", description: "Poudre matcha, perles de tapioca, lait.", price: "Sur demande", image: bubbleTeaImg, tag: "Latte" },
      { name: "Brown Sugar", description: "Sirop caramel brun, lait, tapioca.", price: "Sur demande", image: tigerSugar, tag: "Latte" },
      { name: "Oréo", description: "Crème oreo, lait, perles.", price: "Sur demande", image: bubbleTeaImg, tag: "Latte" },
      { name: "Rose & Framboise", description: "Poudre de fraise, sirop rose, lait.", price: "Sur demande", image: tigerSugar, tag: "Latte" },
      { name: "Taro", description: "Poudre de taro violet, lait.", price: "Sur demande", image: bubbleTeaImg, tag: "Latte" },
    ],
  },
  {
    id: "smoothies",
